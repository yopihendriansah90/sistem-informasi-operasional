              ...
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-lg">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo $sim['nomorBpjs'] ?></td>
                    <td>
                      <a onclick="hapus_data(<?php echo $sim['id']?>)" class="btn btn-sm btn-danger m-1">Hapus</a>
                      <a href="index.php?page=edit-bpjs&&id=<?php echo $sim['id'];?>" class="btn btn-sm btn-success m-1">Edit</a>
                      ...
                      data-target="#modal-view" href="#" data-nomorBpjs="<?php echo $sim['nomorBpjs'] ?>"
