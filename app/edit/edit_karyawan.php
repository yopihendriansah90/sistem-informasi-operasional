...
<section class="content">
    <div class="container-fluid">
        <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form method="POST" action="update/update_karyawan.php" enctype="multipart/form-data">
              <div class="modal-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nama karyawan" name="nama" value="<?=$view['nama'] ?>">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- text input -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                     <label class="form-label" for="customFile">Upload Foto KTP</label>
                        <input type="file" name="foto" class="form-control" id="customFile" <?=($view['fotoKtp'] == '') ? "required" : ""; ?> />
                    </div>
                  </div>
                  <!-- menampilkan image -->
                  <div class="row">
                ...
                <div class="modal-footer justify-content-between">
                  <a href="index.php?page=data-karyawan" class="btn btn-danger" >Batal</a>
